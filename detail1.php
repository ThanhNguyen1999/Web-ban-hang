...
<html lang="en">
	...
	<?php
		...
		$sanpham = $connect->printData('SELECT * FROM sphot WHERE MaSP="'.$_GET['id'].'"');
	?>
		<div class="item">
			<div class="item__img">
				<?php 
			...
			<div class="info">
				...
				<div class="danhgia">
					...
					<i class="fa fa-star-o" aria-hidden="true"></i>
					<i class="fa fa-star-o" aria-hidden="true"></i>
					<a href="a.html">Không có đánh giá</a>
				</div>
				...
				<?php 
				$giasp = $sanpham[0]['Gia'];
				echo '<a href=""><h4>'.number_format("$giasp").' vnđ</h4></a>';
				?>
				...
				<div class="nut">
					<button class="nutb nut__mua">Mua ngay</button>
